...
def main(input_path, output_path):
    ...
    for month in range(1, 13):
        ...
        try:
            ...
            if variable_to_smooth in ds.data_vars:
                ...
                time_values.append(ds['time'].values[0])  # Extract the actual time value
    ...
    with nc.Dataset(output_file, 'w', format='NETCDF4') as ncfile:
        ...
        salt_var = ncfile.createVariable('salt', 'f4', ('time', 'lat', 'lon'), fill_value=-9.99e+33)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process and concatenate NetCDF files with smoothing.")
    parser.add_argument("input_path", type=str, help="Path to the directory containing input NetCDF files.")
    parser.add_argument("output_path", type=str, help="Path to the directory where the output NetCDF file will be saved.")
